...
// CO2 calibration values - adjusted for lower range
#define CO2_MIN 200    // Minimum CO2 level
#define CO2_MAX 1000   // Maximum CO2 level
#define ADC_MIN 0      // Minimum ADC reading
#define ADC_MAX 1000   // Adjusted ADC max for better low-end sensitivity

HardwareSerial CO2Serial(1); // Using UART1
